...
export { default as UploadImg3 } from './uploadimg3/Uploadimg3';
export { default as KeyModel } from './keymodelselect/KeyModelSelect';
export { default as KeyModelMortice } from './keymodelselect/KeyModelSelectMortice';