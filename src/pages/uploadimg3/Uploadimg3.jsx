...
const Uploadimg3 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        let response = await axios.get(`https://keys-backend.vercel.app/getKeys/${data}`);
        ...
        try {
          ...
          let response = await axios.get(`https://keys-backend.vercel.app/mortice/getKeys`, {
            params: {
              reference_number: decodedData
            }
          })
          setKeyData(response.data);
        } catch (error) {
